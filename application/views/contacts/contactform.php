	    	<article>
	    		...
	    		<form action="success" metho="POST">
					<div class="field">
	                    <div class="label"><label for="fullname">Име:</label></div>
	                    <div class="inp">
	                    	<input type="text" name="fullname" id="fullname" class="f_input" />              	
	                    </div>
	                </div>
	    			<div class="field">
		        ...
		        <div class="list">
					<div class="item">
						<div class="number">+359883481987</div>
						<div class="message">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud</div>
						<div class="date">15:14:21 24.05.2015</div>
						<div class="clear"></div>
					</div>
					<div class="item">
						<div class="number">+359883481987</div>
